...
const Appoinment = () => {
    return (
        <div className="flex items-center justify-center p-12 bg-red-500">

            <div className="mx-auto w-full mt-14 max-w-[550px] bg-red-500">
                <form>
                    <div className="mb-5">
                    ...
                    <div>
                        <button
                            className="hover:shadow-form w-full rounded-md bg-[#4e46e8] py-3 px-8 text-center text-base font-semibold text-white outline-none hover:bg-blue-500">
                            Book Appointment
                        </button>
                    </div>
                </form>
